    ...
    <main id="main">
      ...
      <Section spacing="lg" tone="muted">
        ...
        {fellowship.committee.length === 0 ? (
          ...
          // Arched monogram medallions, centred so any number sits balanced —
          // the same arch language as the clergy and church committee, ready to
          // carry portraits and showing a gilded monogram until they do.
          <StaggerGroup
