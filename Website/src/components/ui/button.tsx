  ...
  "inline-flex items-center justify-center gap-2 text-center rounded-full font-medium transition-all duration-300 ease-[var(--ease-out-expo)] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary:
          "bg-gradient-to-b from-brand-600 to-brand-700 text-[var(--primary-foreground)] shadow-[0_1px_2px_oklch(0.257_0.075_250/0.35),inset_0_1px_0_oklch(1_0_0/0.16)] hover:from-brand-700 hover:to-brand-800 hover:shadow-[0_6px_18px_oklch(0.257_0.075_250/0.28),inset_0_1px_0_oklch(1_0_0/0.16)] active:scale-[0.98]",
        secondary:
        ...
        accent:
          "bg-gradient-to-b from-accent-500 to-accent-600 text-white shadow-[0_1px_2px_oklch(0.352_0.068_62/0.35),inset_0_1px_0_oklch(1_0_0/0.22)] hover:from-accent-600 hover:to-accent-700 hover:shadow-[0_6px_18px_oklch(0.352_0.068_62/0.3),inset_0_1px_0_oklch(1_0_0/0.22)] active:scale-[0.98]",
        ghost:
