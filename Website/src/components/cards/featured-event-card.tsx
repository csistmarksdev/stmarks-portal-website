...
export async function FeaturedEventCard({
  ...
  return (
    <article className="group relative isolate overflow-hidden rounded-[var(--radius-sanctuary)] bg-sand-950 text-white shadow-sanctuary ring-1 ring-white/10">
      <div className="grid lg:grid-cols-2">
        ...
        <div className="relative flex flex-col justify-center gap-5 p-8 sm:p-10 lg:p-14">
          <div className="flex items-center gap-3">
            ...
            <span className="label text-accent-300">{t("featured")}</span>
          </div>
          ...
          <span aria-hidden className="h-px w-20 rule-gild" />
