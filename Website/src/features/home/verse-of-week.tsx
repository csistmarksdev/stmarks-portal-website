  ...
  return (
    <section className="relative isolate overflow-hidden bg-sand-950 py-28 text-white sm:py-36 lg:py-44">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(55% 60% at 22% 18%, oklch(0.508 0.105 65 / 0.42), transparent 68%), radial-gradient(45% 55% at 82% 82%, oklch(0.586 0.19 28 / 0.34), transparent 70%)",
        }}
      />
          ...
          <figure className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
            ...
            <blockquote className="mt-10 sm:mt-12">
              {/* A faint brass halo lifts the type off the ground without
                  tinting it. */}
              <p className="text-balance font-display text-[1.75rem] leading-[1.3] tracking-[-0.015em] [text-shadow:0_2px_60px_oklch(0.702_0.138_74/0.28)] sm:text-4xl lg:text-[3.25rem] lg:leading-[1.2]">
